...
where *CPUE* is the catch of legal size male GKC per unit of effort for each logbook entry (*le*). Equation (1.1) is then applied to all logbook entries and averaged for a given management area and season where:
...
where *catch* is for a given logbook entry (*le*), *gkc* is golden king crab and *tc* is Tanner crab.Then subsequently Equations (1.1) and (1.2) will be applied to calcuate CPUE.
