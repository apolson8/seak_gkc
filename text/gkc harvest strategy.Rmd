...
## Proposed plan {-}
Here we propose a harvest strategy plan that informs inseason and postseason management using fishery dependent performance indicators and management decision rules. 
...
A secondary performance indicator that will be used in this harvest strategy is commercial catch rate obtained from fish ticket data. With fish ticket data, CPUE is calculated using each harvest landing for the entire season divided by the difference between the first and last catch date (which is defined as active fishing season). This secondary CPUE indicator is defined as "pounds per pot day" and will aid in understanding catch rates over time:

\begin{equation}
active \ fishing \ season(days) = (date_{first \ catch} - date_{last \ catch})
\tag{4}
\end{equation}


\begin{equation}
CPUE_{f} = \frac {harvest(lbs)} {active \ fishing \ season(days)}
\tag{5}
\end{equation}

where *CPUE* is the harvest (lbs) per day for each fish ticket landing (*f*). Equation (5) is then applied to all fish ticket landings and averaged for a given area and season where:


\begin{equation}
\overline{CPUE_{a,s}} = \frac{\sum{CPUE_{f}}}{n}
\tag{6}
\end{equation}

where *a* is a given management area, *s* is a given season, and *n* is the total number of fish ticket landings. 

Supplementary information that may be evaluated in this harvest strategy includes biological, local ecological knowledge (LEK), and other anecdotal information that may not be captured quantitatively in this harvest strategy framework.
...
```{r, fig.cap = "Northern golden king crab active fishing season CPUE with an average from 1995-2017 per industry request (dotted line) and a long-term average from 1970-Present (solid line).", out.width= "500px"}
knitr::include_graphics("../figures/2020/Northern_lbs_activeF_industry_request.png")
...
```{r, fig.cap = "Icy Strait golden king crab active fishing season CPUE with an average from 1995-2017 per industry request (dotted line) and a long-term average from 1970-Present (solid line).", out.width= "500px"}
knitr::include_graphics("../figures/2020/Icy Strait_lbs_activeF_industry_request.png")
...
```{r, fig.cap = "North Stephens Passage golden king crab active fishing season CPUE with an average from 1995-2017 per industry request (dotted line) and a long-term average from 1970-Present (solid line).", out.width= "500px"}
knitr::include_graphics("../figures/2020/North Stephens Passage_lbs_activeF_industry_request.png")
...
```{r, fig.cap = "East Central golden king crab active fishing season CPUE with an average from 1995-2017 per industry request (dotted line) and a long-term average from 1970-Present (solid line).", out.width= "500px"}
knitr::include_graphics("../figures/2020/East Central_lbs_activeF_industry_request.png")
...
```{r, fig.cap = "Mid-Chatham Strait golden king crab active fishing season CPUE with an average from 1995-2017 per industry request (dotted line) and a long-term average from 1970-Present (solid line).", out.width= "500px"}
knitr::include_graphics("../figures/2020/Mid-Chatham_lbs_activeF_industry_request.png")
...
```{r, fig.cap = "Lower Chatham Strait golden king crab active fishing season CPUE with an average from 1995-2017 per industry request (dotted line) and a long-term average from 1970-Present (solid line).", out.width= "500px"}
knitr::include_graphics("../figures/2020/Lower Chatham_lbs_activeF_industry_request.png")
...
```{r, fig.cap = "Southern golden king crab active fishing season CPUE with an average from 1995-2017 per industry request (dotted line) and a long-term average from 1970-Present (solid line).", out.width= "500px"}
knitr::include_graphics("../figures/2020/Southern_lbs_activeF_industry_request.png")
